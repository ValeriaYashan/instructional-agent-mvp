...
def _ensure_instructional_object(session, object_id: str) -> None:
    """
    CODE-CR-42 (Human Code Review de Iteracion 3): ya no existe ningun
    trigger que auto-provisione instructional_object. El orden correcto
    es siempre InstructionalObject primero, ObjectVersion despues - este
    helper de fixture/setup se actualiza para cumplirlo explicitamente.
    No cambia ninguna aserción ni comportamiento aprobado de los tests
    de Iteracion 1 - solo su fixture de datos, tal como autoriza esta
    revision ("regression tests may update fixture/setup data to
    satisfy the new legitimate FK").
    """
